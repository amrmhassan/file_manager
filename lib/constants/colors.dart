...
// const Color kCardBackgroundColor = Color.fromARGB(255, 243, 243, 243);
// const Color kLightCardBackgroundColor = Color.fromARGB(255, 213, 213, 213);
// const Color kInactiveColor = Color(0xff9A9CA3);
// const Color kBlueColor = Colors.blue;

// //? text colors
// const Color kActiveTextColor = Color(0xFF362B4B);
// const Color kInActiveTextColor = Color.fromARGB(255, 115, 122, 130);

// //? icons colors
// const Color kDangerColor = Colors.red;
// const Color kGreenColor = Colors.green;
// const Color kMainIconColor = Colors.grey;
